...
const BuyerDropDown = () => {
    ...
    return (
        <div className="dropdown relative">
            <a className="px-2 py-2 text-white font-medium leading-tight uppercase rounded focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out flex items-center whitespace-nowrap cursor-pointer" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                {/* User avatar icon */}
