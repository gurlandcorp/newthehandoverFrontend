...
const Contact: NextPage = () => {
    ...
    return (
		<>
			...
			{/* end of search Bar  */}
			<section className="width mx-auto grid grid-cols-1 md:grid-cols-2">
				<div>
				...
				<div>
					<div className="contact-content">
						<h3 className="text-3xl theme-color px-5 py-2 mb-3 font-medium">Office Information</h3>
						<div className="px-5">
							<ul className="mb-5">
								...
								<ul className="grid grid-cols-5">
									<li className='mx-1'>
										<a href="https://www.facebook.com/">
											<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="25px" height="25px"><linearGradient id="Ld6sqrtcxMyckEl6xeDdMa" x1="9.993" x2="40.615" y1="9.993" y2="40.615" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#2aa4f4"/><stop offset="1" stopColor="#007ad9"/></linearGradient><path fill="url(#Ld6sqrtcxMyckEl6xeDdMa)" d="M24,4C12.954,4,4,12.954,4,24s8.954,20,20,20s20-8.954,20-20S35.046,4,24,4z"/><path fill="#fff" d="M26.707,29.301h5.176l0.813-5.258h-5.989v-2.874c0-2.184,0.714-4.121,2.757-4.121h3.283V12.46 c-0.577-0.078-1.797-0.248-4.102-0.248c-4.814,0-7.636,2.542-7.636,8.334v3.498H16.06v5.258h4.948v14.452 C21.988,43.9,22.981,44,24,44c0.921,0,1.82-0.084,2.707-0.204V29.301z"/></svg>
										</a>
									</li>
									<li className='mx-1'>
										<a href="https://twitter.com/">
											<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="25px" height="25px"><linearGradient id="_osn9zIN2f6RhTsY8WhY4a" x1="10.341" x2="40.798" y1="8.312" y2="38.769" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#2aa4f4"/><stop offset="1" stopColor="#007ad9"/></linearGradient><path fill="url(#_osn9zIN2f6RhTsY8WhY4a)" d="M46.105,11.02c-1.551,0.687-3.219,1.145-4.979,1.362c1.789-1.062,3.166-2.756,3.812-4.758	c-1.674,0.981-3.529,1.702-5.502,2.082C37.86,8.036,35.612,7,33.122,7c-4.783,0-8.661,3.843-8.661,8.582	c0,0.671,0.079,1.324,0.226,1.958c-7.196-0.361-13.579-3.782-17.849-8.974c-0.75,1.269-1.172,2.754-1.172,4.322	c0,2.979,1.525,5.602,3.851,7.147c-1.42-0.043-2.756-0.438-3.926-1.072c0,0.026,0,0.064,0,0.101c0,4.163,2.986,7.63,6.944,8.419	c-0.723,0.198-1.488,0.308-2.276,0.308c-0.559,0-1.104-0.063-1.632-0.158c1.102,3.402,4.299,5.889,8.087,5.963	c-2.964,2.298-6.697,3.674-10.756,3.674c-0.701,0-1.387-0.04-2.065-0.122C7.73,39.577,12.283,41,17.171,41	c15.927,0,24.641-13.079,24.641-24.426c0-0.372-0.012-0.742-0.029-1.108C43.483,14.265,44.948,12.751,46.105,11.02"/></svg>
										</a>
									</li>
									<li className='mx-1'>
			...
			<section className="width mx-auto my-16">
				<div className="grid grid-cols-1 md:grid-cols-2">
					<div className={`${styles.contactNeedHelp} h-max`}>
						<h3 className="text-xl theme-color">Need help with something?</h3>
					...
					<div className="contact-content px-5">
						<h3 className="text-xl theme-color mb-3 font-medium">Quick Contact</h3>
						<p className="text-gray-500">
							Borem ipsum dolor sit amet conse ctetur adipisicing elit sed
							do eiusmod Eorem ipsum dolor sit amet conse ctetur.
						</p>
						<form className="contact-box rounded p-4 shadow" onSubmit={(e) => handleSubmit(e)}>
							<div className="row">
								<div className="mb-4">
									<label className="text-base">Name *</label>
									<input
										type="text"
										className="w-full border border-solid rounded p-2 mb-2"
										name="name"
										placeholder="Name*"
								...
								<div className="form-group col-lg-12">
									<button className="bg-black border border-black border-solid duration-300 ease-in-out hover:bg-white hover:text-black inline-block m-1 px-4 py-1 rounded-3xl text-white"
									> Send message </button>
								</div>
							</div>
